                    ...
                    <div class="modal-body">
                      <form method = "POST" action = "{{route('infokampus.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            {{-- <textarea class="form-control" id="alamatkampus" name = "alamatkampus" alamatkampus}}"></textarea> --}}
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="deskripsi_kampus" name = "deskripsi_kampus" cols="30" rows="10"></textarea>
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="jurusankampus" name = "jurusankampus" cols="30" rows="10"></textarea>
                            {{-- <input type="text" class="form-control" id="deskripsi_kampus" name = "deskripsi_kampus" > --}}
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            {{-- <textarea class="form-control" id="alamatkampus" name = "alamatkampus" alamatkampus}}"></textarea> --}}
                            <input type="text" class="form-control" id="biaya_kuliah" name = "biaya_kuliah" >
                          </div>
   ...
   <div class="col-md-4 col-mb-3">
    <div class="card shadow mb-4">
        ...
        <center><h5 class="card-title m-0 font-weight-bold text-dark" style = "text-align:center;">{{$infocampus->namakampus}}</h5></center>
         <center>   <p class="card-text" style = "margin-top:5px;margin-bottom:5px;">{{ Str::limit($infocampus->deskripsi_kampus,150)}}</p> </center>
...
{{--
             <a href="{{route('infokampus.edit',$class->id)}}" style = "margin-bottom:10px;margin-top:10px;" class="btn btn-success">Edit Kelas</a> --}}
               ...
               <a href="{{route('informasikampusspesifik',$infocampus->id)}}" style = "margin-bottom:10px;margin-top:10px; margin-left:5px;margin-right:5px;" class="btn btn-primary">Lihat Kelas</a>
